...
setwd("C:/meta2016") 
j_file1 <-"C:/meta2016/talks_art.json"
j_file2 <-"C:/meta2016/talks_free.json"
j_file3 <-"C:/meta2016/talks_music.json"
j_file4 <-"C:/meta2016/talks_time.json"

###Read a json file to workspace 
talk_creativ<-fromJSON(file=j_file1, method="C") 
talk_creativ<-fromJSON(file=j_file2, method="C")
talk_creativ<-fromJSON(file=j_file3, method="C")
talk_creativ<-fromJSON(file=j_file4, method="C")
str(talk_creativ) 
...
###Remove sparse terms 
ted_tdm_sparse <- removeSparseTerms(ted_tdm, sparse = 0.9) 
ted_tdm_sparse$nrow 
...
png("./dendrogram_sparse90_Ward.png", width = 1200, height=600) 
plot(fit) 
###k= number of clusters 
rect.hclust(fit, k=12) 
dev.off() 
